...
function todayISO(): string {
  // Use local calendar components, not toISOString() — that converts to
  // UTC first, which can land on the wrong day depending on the time of
  // day and the user's timezone offset.
  const now = new Date()
